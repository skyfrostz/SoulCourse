...
func migrateRequirementRecords(db *sql.DB) error {
	...
	records := []requirement{
		...
		{"requirement-software-engineering", "软件工程", "物理+化学强约束", `["软件工程","物理","化学"]`, "软件工程专业重点核对物理、化学要求。", "/requirements/软件工程", `["物理","化学"]`, "计算机与电子信息"},
		{"requirement-data-science", "数据科学与大数据技术", "物理+化学强约束", `["数据科学","物理","化学"]`, "数据科学与大数据技术专业重点核对物理、化学要求。", "/requirements/数据科学与大数据技术", `["物理","化学"]`, "计算机与电子信息"},
		{"requirement-cybersecurity", "网络空间安全", "物理+化学强约束", `["网络安全","物理","化学"]`, "网络空间安全专业重点核对物理、化学要求。", "/requirements/网络空间安全", `["物理","化学"]`, "计算机与电子信息"},
		{"requirement-mechanical", "机械设计制造及其自动化", "物理+化学强约束", `["机械","物理","化学"]`, "机械类专业重点核对物理、化学要求。", "/requirements/机械设计制造及其自动化", `["物理","化学"]`, "工学"},
		{"requirement-automation", "自动化", "物理+化学强约束", `["自动化","物理","化学"]`, "自动化专业重点核对物理、化学要求。", "/requirements/自动化", `["物理","化学"]`, "工学"},
		{"requirement-communication", "通信工程", "物理+化学强约束", `["通信工程","物理","化学"]`, "通信工程专业重点核对物理、化学要求。", "/requirements/通信工程", `["物理","化学"]`, "工学"},
		{"requirement-civil", "土木工程", "物理+化学强约束", `["土木工程","物理","化学"]`, "土木工程专业重点核对物理、化学要求。", "/requirements/土木工程", `["物理","化学"]`, "工学"},
		{"requirement-architecture", "建筑学", "物理/历史按院校核对", `["建筑学","物理","历史"]`, "建筑学专业组要求存在院校差异，应逐校核对。", "/requirements/建筑学", `["物理","历史"]`, "工学"},
		{"requirement-chemistry", "化学", "物理+化学优先核对", `["化学","物理"]`, "化学专业重点核对物理、化学要求。", "/requirements/化学", `["物理","化学"]`, "理学"},
		{"requirement-mathematics", "数学与应用数学", "物理优先核对", `["数学","物理"]`, "数学与应用数学专业重点核对物理要求及院校目录。", "/requirements/数学与应用数学", `["物理"]`, "理学"},
		{"requirement-physics", "物理学", "物理优先核对", `["物理"]`, "物理学专业重点核对物理要求。", "/requirements/物理学", `["物理"]`, "理学"},
		{"requirement-biology", "生物科学", "物理/化学按院校核对", `["生物","物理","化学"]`, "生物科学专业组要求存在院校差异，应逐校核对。", "/requirements/生物科学", `["物理","化学"]`, "理学"},
		{"requirement-english", "英语", "历史/物理按院校核对", `["英语","历史","语言"]`, "英语专业组要求存在院校差异，应逐校核对。", "/requirements/英语", `["历史","物理"]`, "人文社会科学"},
		{"requirement-chinese-language", "汉语言文学", "历史优先核对", `["汉语言文学","历史"]`, "汉语言文学专业重点核对历史要求及院校目录。", "/requirements/汉语言文学", `["历史"]`, "人文社会科学"},
		{"requirement-journalism", "新闻学", "历史/物理按院校核对", `["新闻学","历史","政治"]`, "新闻学专业组要求存在院校差异，应逐校核对。", "/requirements/新闻学", `["历史","政治"]`, "人文社会科学"},
		{"requirement-international-economics", "国际经济与贸易", "历史/物理按院校核对", `["国际经济","历史","物理"]`, "国际经济与贸易专业组要求存在院校差异，应逐校核对。", "/requirements/国际经济与贸易", `["历史","物理"]`, "经济与管理"},
		{"requirement-accounting", "会计学", "历史/物理按院校核对", `["会计","历史","物理"]`, "会计学专业组要求存在院校差异，应逐校核对。", "/requirements/会计学", `["历史","物理"]`, "经济与管理"},
		{"requirement-administration", "行政管理", "历史/物理按院校核对", `["行政管理","历史","政治"]`, "行政管理专业组要求存在院校差异，应逐校核对。", "/requirements/行政管理", `["历史","政治"]`, "经济与管理"},
		{"requirement-nursing", "护理学", "物理/化学按院校核对", `["护理学","物理","化学"]`, "护理学专业组要求存在院校差异，应逐校核对。", "/requirements/护理学", `["物理","化学"]`, "医学与生命科学"},
		{"requirement-pharmacy", "药学", "物理+化学优先核对", `["药学","物理","化学"]`, "药学专业重点核对物理、化学要求。", "/requirements/药学", `["物理","化学"]`, "医学与生命科学"},
		{"requirement-finance-management", "财务管理", "历史/物理按院校核对", `["财务管理","历史","物理"]`, "财务管理专业组要求存在院校差异，应逐校核对。", "/requirements/财务管理", `["历史","物理"]`, "经济与管理"},
		{"requirement-visual-communication", "视觉传达设计", "按院校目录核对", `["视觉传达","艺术"]`, "艺术类专业须结合省级统考和院校专业目录核对。", "/requirements/视觉传达设计", `["历史","物理"]`, "艺术学"},
		{"requirement-physical-education", "体育教育", "按院校目录核对", `["体育教育","体育"]`, "体育类专业须结合省级统考和院校专业目录核对。", "/requirements/体育教育", `["历史","物理"]`, "教育学"},
	}
	for _, item := range records {
